...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-stone-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
            ...
            className={`flex items-center px-4 py-2.5 text-sm font-medium rounded-lg transition-colors
              ${
                view === item.view
                  ...
                  : 'text-gray-600 dark:text-gray-300 hover:bg-stone-100 dark:hover:bg-gray-700'
              }`}
          >
      ...
      <div className="px-4 py-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
        <a
          href="#"
          className="flex items-center px-4 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-stone-100 dark:hover:bg-gray-700 rounded-lg"
        >

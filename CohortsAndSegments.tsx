    ...
    <div className="grid grid-cols-1 gap-6">
       <div className="bg-stone-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <select className="bg-stone-100 dark:bg-gray-700 p-2 rounded-md border border-gray-300 dark:border-gray-600 focus:ring-primary-500 focus:border-primary-500">

...
import { View, Role, Theme, Tenant, SavedView } from '../types';
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <AppContext.Provider value={{ view, setView, role, setRole, privacyMode, setPrivacyMode, theme, setTheme, tenant, setTenant, savedViews, saveCurrentView, deleteView }}>
            {children}
        </AppContext.Provider>
    );
};

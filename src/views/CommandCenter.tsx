...
// Import widget components with corrected casing (identifiers must match JSX usage)
        ...
        {widgets.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {widgets.length < 4 && (
              <div
                onClick={() => setIsModalOpen(true)}
                className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex items-center justify-center h-96 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >

...
import { useApp } from '../contexts/AppContests'; // Correct path to your context file
...
const ScenarioCard: React.FC<ScenarioCardProps> = ({ icon: Icon, title, description, targetView }) => {
    ...
    return (
        <div
            ...
            className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col"
        >
